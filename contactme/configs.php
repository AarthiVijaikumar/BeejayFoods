...
$configs['from_name']				= 'BeJay Agro Foods';								// Your name will be used in emails
$configs['from_address']			= 'aarthi@motiff.media';							// Your email address used to send emails
$configs['to_addresses']			= array('aarthi@motiff.media');						// The addresse(s) where to send all the requests
/* END - Required Config */
